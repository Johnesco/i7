...
- Zork I: `projects/zork1/index.html` — rich page with prose, version history, community links
- Dracula: `projects/dracula/index.html` — custom tabbed source viewer page
- Fever Dream: `projects/feverdream/index.html`
- Sample: `projects/sample/index.html`
...
| `binary` | string | Yes | Path to base64-encoded game binary relative to ifhub root (e.g., `"projects/sample/lib/parchment/sample.ulx.js"`) |
